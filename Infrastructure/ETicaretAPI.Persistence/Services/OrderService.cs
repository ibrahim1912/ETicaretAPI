    ...
    public class OrderService : IOrderService
    {
        ...
        public async Task<ListOrder> GetAllOrdersAsync(int page, int size)
        {
           ...
           .Include(o => o.Basket)
            ...
            var data2 = from order in data
                        ...
                        from _co in co.DefaultIfEmpty()  //order a karşılık boş olmayanları getirecek
                        select new
                        {
                            Id = order.Id,
            ...
            //var data3 = data2.Skip(page * size).Take(size);
            return new()
            {
                TotalOrderCount = await query.CountAsync(),
                Orders = await data2.Select(o => new  //dataydı- data2 yptık  Completed için değiştirdik
                {
                    Id = o.Id,
        ...
        public async Task<(bool, CompletedOrderDto)> CompleteOrderAsync(string id)
        {
            ...
            if (order != null)
            {
                ...
                }); //bu işlemi yapıyorsa geriye true döndük //yani order tamamlancağı garanti oldu//tupple yaptık
            }
